...
export type AppAction =
  ...
  | { type: 'ADD_CONVERT_JOB'; payload: ConvertJob }
  | { type: 'UPDATE_CONVERT_JOB'; payload: { id: string; updates: Partial<ConvertJob> } }
  | { type: 'REMOVE_CONVERT_JOB'; payload: string }
  | { type: 'CLEAR_CONVERT_JOBS' }
  | { type: 'TOGGLE_SCAN_FILE'; payload: string }
  | { type: 'SELECT_ALL_SCAN_FILES' }
  | { type: 'DESELECT_ALL_SCAN_FILES' };
